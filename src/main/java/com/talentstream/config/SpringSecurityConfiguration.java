...
class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		httpSecurity.cors().and().csrf().disable().authorizeRequests() .antMatchers(HttpMethod.OPTIONS, "/**").permitAll()
.antMatchers(
				...
				"/api/mentor-connect/recruiter/createMentorConnect")
		.hasAnyRole("JOBRECRUITER")
				.antMatchers("/jobVisit/applicant/track-visit", "/skill-badges/{id}/skill-badges", "/skill-badges/save",
						...
						"/notifications/move-to-seen-everywhere/{applicantId}")
				...
				.antMatchers( "/v2/api-docs", "/swagger-ui/**", "/swagger-resources/**", "/webjars/**", "/actuator/**","/api/analytics/**")
