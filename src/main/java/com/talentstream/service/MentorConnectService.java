...
public class MentorConnectService {
	...
	public String createMentorConnect(MentorConnectRequestDTO req) {
		...
		logger.info("service - createMentorConnect - sending applicant notifications to {} applicants", applicantIds.size());
	...
	public String registerMentorConnect(Long mentorConnectId, Long applicantId) {
		...
		if (existingRegistration != null) {
			logger.warn("service - registerMentorConnect - Applicant with ID={} is already registered for Mentor Connect ID={}",
	...
	public List<Long> getAllRegisteredMentorConnects(Long applicantId) {
	    ...
	    try {
	        List<Long> mentorConnectIds =
	                mentorConnectregistrationsRepository.findMentorConnectIdsByApplicantId(applicantId);
