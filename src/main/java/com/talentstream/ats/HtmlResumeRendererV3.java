...
public class HtmlResumeRendererV3 implements ResumeHtmlRenderer {
	...
	public String render(ResumeSchemaDTO resume,
		...
		html.append("<style>");
		html.append(
				"body{font-family:Arial,Helvetica,sans-serif;background:#ffffff;margin:0;padding:0;color:#1a1a1a;}");
		html.append(
				".wrapper{width:100%;max-width:760px;margin:20px auto;background:#ffffff;padding:30px;box-sizing:border-box;}");
		...
		/* ===== TWO COLUMN LAYOUT ===== */
		html.append("<table width='100%' cellspacing='0' cellpadding='0'><tr>");
